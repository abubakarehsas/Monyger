...
public abstract class DemoBase extends AppCompatActivity {
    ...
    protected Typeface gothamBold, gothamMedium, gothamBook, gothamLight, gothamXLight;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gothamLight = Typeface.createFromAsset(getAssets(), "GothamHTF-Light.otf");
        gothamXLight = Typeface.createFromAsset(getAssets(), "GothamHTF-XLight.otf");
    }
